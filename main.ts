...
function testStringEquality(srt1: string, srt2: string):boolean {
    return srt1 === srt2;
}
...
function  UsingLowercase(str1:string, str2:string):boolean{
...
function testLogicalAnd(condition1: boolean, condition2: boolean): boolean {
    return condition1 && condition2;
}

// Function to check logical "OR" operator
function testLogicalOr(condition1: boolean, condition2: boolean): boolean {
    return condition1 || condition2;
}
...
function doesArrayIncludeItem<T>(array: T[], item: T): boolean {
...
function doesArrayNotIncludeItem<T>(array: T[], item: T): boolean {
    return !array.includes(item);
}
